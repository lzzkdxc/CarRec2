...
import com.example.carrec2.ui.fake.FakeFragment;
    ...
    private static void postprocess(Mat frame, List<Mat> outs) {
        ...
        if (idxs.total() > 0) {
            ...
            if(box_car_max_confidences>0){
                FakeFragment.getMainActivity().Advanced_Car_recognition(box_car);
            ...
            if(box_plate_max_confidences>0){
                FakeFragment.getMainActivity().Advanced_Plate_recognition(box_plate);

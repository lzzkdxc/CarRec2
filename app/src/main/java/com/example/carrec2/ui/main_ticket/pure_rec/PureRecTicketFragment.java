...
public class PureRecTicketFragment extends Fragment implements View.OnTouchListener, CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        galleryViewModel =
                ViewModelProviders.of(this).get(PureRecViewTicketModel.class);
